...
# in the same directory (e.g. update-otel-desktop-viewer.sh).
#
# The sourcing script must set these variables:
#   PKG_NAME        - Package name (e.g., "otel-desktop-viewer")
#   GITHUB_REPO     - GitHub owner/repo (e.g., "CtrlSpice/otel-desktop-viewer")
