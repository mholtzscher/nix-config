...
const schneierFacts = [
  ...
  "Bruce Schneier sneers and solves GÃ¶del's incompleteness theorems.",
  ...
  "The set of Bruce Schneier's weaknesses is a mathematical constant. It is represented by the symbol âˆ….",
  ...
  'Bruce Schneier the Ladykiller: Rot13( "Bruce Schneier" ) is an anagram for "Approve her fur"!',
  ...
  "Bruce Schneier feeds SchrÃ¶dinger's cat on his back porch. Without opening the box.",
  ...
  "Bruce Schneier can put a cycle in a tree.",
  ...
  "Bruce Schneier has a life. Not like you all NERDS.",
  'Bruce Schneier thinks the movie "Pi" is a documentary.',
  ...
  "Johnny can't encrypt because Bruce Schneier likes it that way.",
  ...
  "Erwin SchrÃ¶dinger had a mere cat; Bruce Schneier has a Bengal tiger.",
  ...
  "Bruce Schneier sits at the top of the arithmetical hierarchy.",
  "Bruce Schneier watches Blu-ray movies by looking at the discs.",
  ...
  "Differential of the form BRUCE -> SCHNEIER can be used to break any block cipher, regardless of it's number of rounds.",
  "Bruce Schneier's cryptographic know-how can't even fit in a ZFS filesystem.",
  "There are no composite numbers. Only prime numbers Bruce has broken into smaller pieces.",
  "Bruce Schneier does not tie his shoes, he encrypts them.",
  "Bruce Schneier can collapse the polynomial hierarchy, with a roundhouse kick to the face.",
  "Bruce Schneier has the body of a model. A threat model.",
  "Bruce Schneier can snatch the pebble from your hand, even if you aren't holding a pebble.",
  "Bruce Schneier is the guy that put Stephen Hawking in that wheelchair.",
  ...
  'Bruce Schneier knows the cardinality of "the set of all sets except for the set itself".',
  "Bruce Schneier once invited Linus and Theo for dinner. It was a nice evening.",
  ...
  "Only Bruce Schneier knows which inodes are which on helix's filesystem.",
  'When you email Bruce Schneier, you don\'t need to press "send".',
  "Bruce Schneier's first pet name, mother's maiden name and all other answers to his secret questions are random 1024 byte blocks.",
  "Only Bruce Schneier will be able to decipher the steganographic payload hiding in this fact.",
  "Bruce Schneier was the one who cut the Gordian Knot; as a sign of good faith (and because he was the one to tie it in the first place) he gave Alexander the Great the kingship.",
  ...
  "Bruce Schneier is able to read every Unlambda program.",
  "Bruce Schneier counted to infinity - in complex numbers.",
  "Bruce Schneier cracked BD+ in 3.14159265358979323846... seconds.",
  ...
  "Bruce Schneier does not sleep. He preempts everything.",
  ...
  "Bruce Schneier can rotate size n matrices for any n with only two operations: his left fist and his right fist.",
  ...
  "Bruce Schneier is an honorary member of all Diffie-Hellman groups.",
  ...
  "Bruce Schneier uses Jimmy Hoffa's watch as a token for second-factor authentication.",
  "Bruce Schneier can decipher NaN",
  "Bruce Schneier's two-factor authentication consists of his left and right fists.",
  ...
  "If you print the first 3,145,728 digits of Pi, your printer will print an autographed 8-bit, 3.1 megapixel photo of Bruce Schneier.",
  "lolcats are Bruce Schneiers proof that steganography works.",
  "When Bruce Schneier uses a hash function, there are no collisions. It's quite simple. The hash is not a finite number.",
  "Bruce Schneier taught his dog to do a secure handshake",
  "Bruce Schneier has a secret love child with Carol AND Alice.",
  "When Bruce Schneier books all the rooms at Hilbert's Hotel (with a countable infinite number of rooms), <i>no-one else</i> can book a room.",
  "Bruce Schneier's programs aren't threaded; they're chained and padlocked.",
  "Bruce Schneier does not get kidney stones. He gets Rosetta Stones.",
  "Bruce Schneier deduced the state of SchrÃ¶dinger's cat. It is Oklahoma.",
  "Bruce Schneier already knows what you got him for Christmas.",
  "Bruce Schneier knows what Willis was talkin' about.",
  ...
  "If Leonardo had listened to Bruce's recommendations, Dan Brown would still be living in poverty.",
  "Bruce Schneier knew you would read this.",
  ...
  "Bruce Schneier cannot lock himself out of his car.",
  ...
  "Bruce Schneier can guarantee fair exchange without trusted third parties.",
  ...
  "Bruce Schneier doesn't transfer files, he just extracts them from /dev/random.",
  ...
  "Bruce Schneier can calculate MD5 hashes in his head. For any length of data. In constant time. Drunk.",
  "The TSA does not know how to open Bruce's luggage, but it is not locked.",
  "Bruce uses Turing tape as toilet paper.",
  "Bruce doesn't notice when people speak in tongues because he hears plaintext.",
  "The back EMF coming from Bruce's house is cleaner than the mains feed.",
  ...
  "Bruce Schneier invented his own numeral system with base infinity so he can count to infinity with only one digit.",
  "When Bruce Schneier plays Conway's Soldiers he gets all the checkers five places or more above the line.",
  ...
  "Bruce Schneier can watch diplomatic channels using a TiVo.",
  "Alice and Bob are talking about Bruce Schneier, and he knows it.",
  "Bruce Schneier knows rather a lot about security. And, y'know, like cryptostuff and such.",
  ...
  "Bruce Schneier's Twofish algorithm has only 16 rounds, but he never needs to reload.",
  ...
  "When Bruce Schneier sleeps, he snores white noise.",
  ...
  "Bruce Schneier can construct groups that aren't isomorphic to groups of permutations.",
  "Bruce Schneier solved the two envelope paradox by taking both.",
  ...
  "Bruce Schneier turns snake oil into biodiesel in his garage.",
  ...
  "Hashes collide because they're swerving to avoid Bruce Schneier.",
  "IBM's 'Big Blue' was really just Bruce Schneier in a metal box.",
  "Bruce Schneier won the coin toss between Bill Hewlett and Dave Packard.",
  "Bruce Schneier has a set of SSH Bump Keys.",
  "Bruce Schneier can read captchas.",
  "Bruce Schneier doesn't have spare time. He simply goes blowfishing.",
];

function pickRandom(): string {
  return schneierFacts[Math.floor(Math.random() * schneierFacts.length)];
}
